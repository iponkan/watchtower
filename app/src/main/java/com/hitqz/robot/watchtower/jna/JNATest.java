package com.hitqz.robot.watchtower.jna;

import com.hitqz.robot.watchtower.util.CommonMethod;
...
public class JNATest {
    ...
    public void Test_Login_V40() {
        ...
        System.arraycopy("192.168.8.84".getBytes(), 0, loginInfo.sDeviceAddress, 0, "192.168.8.84".length());
        System.arraycopy("admin".getBytes(), 0, loginInfo.sUserName, 0, "admin".length());
        System.arraycopy("abcd1234".getBytes(), 0, loginInfo.sPassword, 0, "abcd1234".length());
